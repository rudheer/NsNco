  ...
  return (
    <Box className={classes.wrapper}>
      <Typography style={{ fontSize: "13px" }}>
        <b style={{ color: "white" }}>
          We invite you to join us and take part in this moment for change
        </b>
        . Driven by our GenZs, The Happy Hippies Show is a web series of
        discussions by the leaders, on these social themes.
      </Typography>
      <Typography className={classes.iconslinkbox} style={{ fontSize: "13px" }}>
        <a onClick={() => setIconopen(true)}>
          Check Out Social Themes That Interest's You
        </a>
      </Typography>
      <Modal open={iconOpen} onClose={() => setIconopen(false)}>
